...
Roll no 6
*/
//C Program to do Matrix Printing, Addition, Multiplication & Transpose.
...
int TransposeMatrix1(int tp[10][10], int rows, int columns){
    int i, j;
...
switch(choice){
    ...
    case 4:
            ...
            printf("\t\t\nTranspose of Matrix\n");
            TransposeMatrix1(matrix1, rows, columns);
            break;
              }
}
